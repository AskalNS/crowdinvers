<%@ Page Title="Байланыс" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ContactDefault.aspx.cs" Inherits="WebApplication6.ContactDefault" %>
  ...
  <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-dark bg-dark"  style="margin-top: -20px;">
    ...
    <div class="container" style="margin-top: 40px;">
        <main aria-labelledby="title">
            ...
            <h3>Бізбен байланысуға қош келдіңіз!</h3>
            <p>
                Сіз біздің платформаны пайдаланбаған болсаңыз да, біз сіздің сұрақтарыңызға жауап беруге және көмек көрсетуге дайынбыз. Төмендегі байланыс ақпараты арқылы бізге хабарласыңыз немесе тікелей хабарласу формасын толтырыңыз.
            </p>
