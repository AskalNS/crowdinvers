<%@ Page Title="Тапсырыстар" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OrdersForBusiness.aspx.cs" Inherits="WebApplication6.Orders" %>
            ...
            <ItemTemplate>
                <div class="card mb-4 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text"><strong>Мақсаттық сома:</strong> <%# Eval("TargetAmount", "{0:C}") %></p>
